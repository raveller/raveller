...
namespace MSMQUtil2006
{
	...
	/// </summary>
	public class PeekrPop2006 : System.Windows.Forms.Form
	{
        ...
        static void Main() 
        {
            Application.Run(new PeekrPop2006());
        }
		...
		private void InitializeComponent()
		{
            ...
            // queueName
            // 
            this.queueName.Items.AddRange(new object[] {
                                                           "\\Private$\\order1s-prod",
                                                           "\\Private$\\sage-prod",
                                                           "\\Private$\\wiltel-prod",
                                                           "\\Private$\\order1s-test",
                                                           "\\Private$\\sage-test",
                                                           "\\Private$\\wiltel-test",
                                                           "\\Private$\\order1s-dev",
                                                           "\\Private$\\sage-dev",
            ...
            // mqServerName
            // 
            this.mqServerName.Items.AddRange(new object[] {
                                                              "vdc3app0006",
                                                              "localhost"});
            ...
            // targetServerCombo
            // 
            this.targetServerCombo.Items.AddRange(new object[] {
                                                                   "vdc3app0006",
                                                                   "localhost"});
            ...
            // targetQueueCombo
            // 
            this.targetQueueCombo.Items.AddRange(new object[] {
                                                                  "\\Private$\\order1s-prod",
                                                                  "\\Private$\\sage-prod",
                                                                  "\\Private$\\wiltel-prod",
                                                                  "\\Private$\\order1s-test",
            ...
            // targetQueue2
            // 
            this.targetQueue2.Items.AddRange(new object[] {
                                                              "\\Private$\\order1s-prod",
                                                              "\\Private$\\sage-prod",
                                                              "\\Private$\\wiltel-prod",
                                                              "\\Private$\\order1s-test",
            ...
            this.Name = "PeekrPop2006";
            this.Text = "Peek \'r Pop 2006";
            ...
            if (mqServerName.Text.Length > 0)
            {
                ...
                try
                {
                    MessageQueue[] QueueList = 
                        MessageQueue.GetPublicQueuesByMachine (mqServerName.Text);
        ...
        private void targetQueueChanged(object sender, System.EventArgs e)
        {
            if (targetServerCombo.Text.Length > 0)
            {
                ...
                {
                    MessageQueue[] QueueList = 
                        MessageQueue.GetPublicQueuesByMachine (targetServerCombo.Text);
