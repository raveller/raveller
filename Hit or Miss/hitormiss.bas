...
20 HS=0:V$=CHR$(176):S$=CHR$C32)
30 L$=S$:FOR X=1 TO 22:L$=L$+S$:NEXT
40 FOR X=1 TO 28
50 B$=B$+CHR$(43-C(X<13)+<X>16))*36):NEXT
60 M$='////////////MISS////////////"
70 H$="============HIT!============"
...
120 CLS
130 COLOR 3:LOCATE 6,1:PRINT "YOUR":PRINT "SCORE:":PRI
NT:PRINT SC
140 COLOR 10:LOCATE 13,1;PRINT "HIGH":PRINT "SCORE:":P
RINTrPRINT HS
150 K0=3:F0R X=2 TO 20:LOCATE X,8:COLOR 5:PRINT V$;
160 IF X>9 AND X<13 THEN PRINT SPCC28);V$:GOTO 180
170 COLOR KO:PRINT B$;:COLOR 5:PRINT V$
180 IF X=12 THEN K0=2
190 NEXT
200 COLOR 15:LOCATE 11,12:PRINT "PRESS ANY KEY TO BEGIN."
210 COLOR ?:LOCATE 23/17:PRINT "PADDLE KEYS:"
220 PRINT TAB(12);"B LEFT N = RIGHT";
230 GOSUB 1030
240 K$=INKEY$:IF KS="" THEN 240
250 LOCATE 11,12;PRINT L$
260 IF RND>.05 THEN 310
270 CH=42:IF H>300 AND RND>.5 THEN CH=43
280 XR=INT(RND*16>+3
290 IF XR>9 AND XR<13 THEN 280
300 LOCATE XR/INTCRND*21)+10:COLOR 7:PRINT CHRSCCH);
...
1010 LOCATE 1,8:COLOR 5:PRINT VS;:COLOR 4:PRINT M$;:COLOR 5:PRINT V$
1020 LOCATE 21,8:PRINT V$;:COLOR 14:PRINT HS;:COLOR 5:PRINT VS:RETURN
1030 LOCATE 1,8:COLOR 5:PRINT V$;:COLOR 14:PRINT H$;:COLOR 5:PRINT V$
1040 LOCATE 21,8:PRINT V$;:COLOR 4:PRINT MS;:COLOR 5:PRINT V$:RETURN
2000 COLOR 3:L0CATE 9,1:PRINT SC;:RETURN